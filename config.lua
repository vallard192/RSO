...
use_donut_shapes = true			-- setting this to false will remove donuts from possible resource layouts
...
global_richness_mult = 1		-- multiply richness all resources
...
multi_resource_richness_factor=0.80 -- any additional resource is multiplied by this value times resources-1
